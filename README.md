...
## <a name='TOC'><a name='TOC'>목차b</a>
  ...
  1. [스와이프 플러그인 (Swipe 3.x) 기본](https://github.com/Guide-Line/Auction-promotion-guide/tree/master/swipe#swipe)
	...
	- [복수의스와이핑index에노출시(플러그인)](https://github.com/Guide-Line/Auction-promotion-guide/tree/master/swipe/%EB%B3%B5%EC%88%98%EC%9D%98%EC%8A%A4%EC%99%80%EC%9D%B4%ED%95%91%EB%85%B8%EC%B6%9C%EC%8B%9C(%ED%94%8C%EB%9F%AC%EA%B7%B8%EC%9D%B8))
